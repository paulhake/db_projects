  ...
  insert into uber_rides values (1, '2020-01-07', 'success', 15, 22, 4);
  insert into uber_rides values (2, '2020-01-09', 'success', 12, 10, 9);
  insert into uber_rides values (3, '2020-01-11', 'success', 9, 4, 4);
  insert into uber_rides values (4, '2020-01-21', 'canceled_by_driver', 13, 11, 40); 
  insert into uber_rides values (5, '2020-02-07', 'success', 15, 22, 4);
  insert into uber_rides values (6, '2020-02-09', 'canceled_by_client', 20, 32, 50);
  insert into uber_rides values (7, '2020-02-11', 'success', 56, 60, 1);
  insert into uber_rides values (8, '2020-02-21', 'canceled_by_driver', 3, 5, 99);   
  insert into uber_rides values (9, '2020-03-07', 'success', 15, 22, 4);
  insert into uber_rides values (10, '2020-03-09', 'success', 12, 10, 9);
  insert into uber_rides values (11, '2020-03-11', 'success', 9, 4, 4);
  insert into uber_rides values (12, '2020-03-21', 'canceled_by_client', 13, 11, 40); 
  insert into uber_rides values (13, '2020-04-07', 'success', 15, 22, 4);
  insert into uber_rides values (14, '2020-04-09', 'success', 16, 9, 1);
  insert into uber_rides values (15, '2020-04-11', 'success', 18, 25, 6);
  insert into uber_rides values (16, '2020-04-21', 'canceled_by_driver', 88, 121, 6);  
